...
const ICON_HEART_FILLED = '<svg class="icon icon-solid" viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 1 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78Z"/></svg>';
    ...
    if (state.tab === "mine") {
      subrow.innerHTML = `
        <div class="segment segment-sm" id="recipe-mine-segment">
          <button type="button" class="${state.mineSub === "own" ? "active" : ""}" data-sub="own">新增</button>
          <button type="button" class="${state.mineSub === "collected" ? "active" : ""}" data-sub="collected">收藏</button>
        </div>
      `;
